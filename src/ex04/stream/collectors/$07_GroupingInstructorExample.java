...
public class $07_GroupingInstructorExample {
	...
	public static void main(final String[] args) {
		...
		final Map<String, List<Instructor>> collect = Instructors.getAll().stream()
				.collect(Collectors.groupingBy(i -> i.getYearOfExperience() > 10 ? "SENIOR" : "JUNIOR", Collectors.filtering(Instructor::isOnlineCourses, Collectors.toList())));
